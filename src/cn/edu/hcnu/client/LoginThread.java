...
public class LoginThread extends Thread {
    ...
    public void run() {
        ...
        t = new JTextField("Version " + "1.1.0" + "        By lisi");
        ...
        final JTextField loginname = new JTextField("lisi");
        ...
        final JTextField loginPassword = new JTextField("lisi1234");
